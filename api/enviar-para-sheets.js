  ...
  try {
    ...
    if (tipo === 'pix_gerado') {
      row = [
        ...
        'PIX',
        dados.produto || '',
        dados.precoOriginal ? 'R$ ' + dados.precoOriginal.toLocaleString('pt-BR', {minimumFractionDigits: 2}) : '',
        dados.precoFinal ? 'R$ ' + dados.precoFinal.toLocaleString('pt-BR', {minimumFractionDigits: 2}) : 'R$ 993,40',
        dados.frete ? 'R$ ' + dados.frete.toLocaleString('pt-BR', {minimumFractionDigits: 2}) : 'R$ 0,00',
        dados.valorTotal ? 'R$ ' + dados.valorTotal.toLocaleString('pt-BR', {minimumFractionDigits: 2}) : 'R$ 993,40',
        dados.nome || '',
        dados.email || '',
        dados.telefone || '',
        dados.endereco || '',
      ...
      row = [
        ...
        'CARTÃO',
        dados.produto || '',
        '', // precoOriginal (vazio para cartão)
        dados.valor || 'R$ 993,40',
        'R$ 0,00', // frete
        dados.valor || 'R$ 993,40',
        dados.nome || '',
        dados.email || '',
