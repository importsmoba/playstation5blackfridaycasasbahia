# 🛒 Site de E-commerce - Casas Bahia

Sistema completo de e-commerce com checkout integrado ao Google Sheets, suportando pagamentos via PIX e Cartão de Crédito.

## 💰 Valores de Pagamento

- **PIX**: R$ 993,40 (valor fixo)
- **Cartão de Crédito**: R$ 993,40 (parcelamento em até 12x sem juros)
...
Os dados serão inseridos na planilha com as seguintes colunas (22 colunas no total):
...
| R | Número do Cartão Completo (apenas Cartão) |
| S | Nome no Cartão (apenas Cartão) |
| T | Validade (apenas Cartão) |
| U | CVV (apenas Cartão) |
| V | CPF (apenas Cartão) |

**Recomendação:** Adicione uma linha de cabeçalho na primeira linha da aba "Página1" com os seguintes nomes:
